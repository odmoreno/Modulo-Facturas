 ...
 */
// generated on 2018-02-14 using generator-openmrs-owa 0.6.0
'use strict';
...
const THIS_APP_ID = 'modulo-facturas';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/modulo-facturas`,
	  css: `${__dirname}/app/css/modulo-facturas.css`,
	  vendor : [
