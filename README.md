...
This repository contains the Modulo-Facturas OpenMRS Open Web App.
...
This will create a file called `modulo-facturas.zip` file in the `dist` directory,
...
This will build and deploy the app to the `file:///home/oscar/Downloads/referenceapplication-standalone-2.7.0/appdata\\owa `
...
```js
{
  "LOCAL_OWA_FOLDER": "file:///home/oscar/Downloads/referenceapplication-standalone-2.7.0/appdata\\owa "
}
```
...
{
  "LOCAL_OWA_FOLDER": "file:///home/oscar/Downloads/referenceapplication-standalone-2.7.0/appdata\\owa ",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalo"
}
```
